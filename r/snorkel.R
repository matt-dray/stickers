...
stamp <- image_read_svg("img/snorkel.svg", width  = 1300, height = 1300)
...
snorkel_hex <-
  image_canvas_hex(
    ...
    border_size = 5,fill_color = "yellow"
  ) |>
  ...
  image_annotate(
    text = "matt-dray.github.io/snorkel",
    font = my_font,
    size = 50,
    color = red_col,
    gravity = "center",
...
image_write(snorkel_hex, "output/snorkel_hex.png")
